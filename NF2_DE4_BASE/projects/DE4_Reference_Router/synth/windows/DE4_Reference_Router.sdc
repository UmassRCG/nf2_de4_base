...
set_false_path -from [get_keepers {DE4_Reference_Router:SOPC_INST|pcie_compiler_0:the_pcie_compiler_0|pcie_compiler_0_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|altpciexpav_tlbp_app:tl_bypass_hip_sopc.tlbp_app|altpciexpav_rx:rx|altpciexpav_fifo:pndgtxrd_fifo|rdptr_g_rd[3]}] -to [get_keepers {DE4_Reference_Router:SOPC_INST|pcie_compiler_0:the_pcie_compiler_0|pcie_compiler_0_core:wrapper|altpcie_hip_pipen1b:altpcie_hip_pipen1b_inst|altpciexpav_tlbp_app:tl_bypass_hip_sopc.tlbp_app|altpciexpav_rx:rx|altpciexpav_fifo:pndgtxrd_fifo|rdptr_g_wr1[3]}]
set_false_path -from [get_keepers {sld_hub:auto_hub|irf_reg[3][1]}] -to [get_keepers {pzdyqx:nabboc|pzdyqx_impl:pzdyqx_impl_inst|XWDE0671[0]}]
set_false_path -from [get_keepers {sld_hub:auto_hub|irf_reg[3][0]}] -to [get_keepers {pzdyqx:nabboc|pzdyqx_impl:pzdyqx_impl_inst|XWDE0671[0]}]
...
set_false_path -from [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_1000_base_x:top_1000_base_x_inst|altera_tse_pcs_control:U_REG|altera_tse_pcs_host_control:U_CTRL|state.STM_TYPE_TX_READ}] -to [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_1000_base_x:top_1000_base_x_inst|altera_tse_pcs_control:U_REG|altera_tse_pcs_host_control:U_CTRL|tx_rd_ack0}]
set_false_path -from [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_gen_host:top_gen_host_inst|altera_tse_mac_control:U_MAC_CONTROL|altera_tse_register_map:U_REG|pause_quant_reg[15]}] -to [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_gen_host:top_gen_host_inst|altera_tse_top_w_fifo_10_100_1000:U_MAC_TOP|altera_tse_top_w_fifo:U_MAC|altera_tse_top_1geth:U_GETH|altera_tse_mac_tx:U_TX|gen_pause_muxc[7]}]
set_false_path -from [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_gen_host:top_gen_host_inst|altera_tse_mac_control:U_MAC_CONTROL|altera_tse_register_map:U_REG|pause_quant_reg[0]}] -to [get_keepers {DE4_Reference_Router:SOPC_INST|tse_mac:the_tse_mac|altera_tse_mac_pcs_pma:altera_tse_mac_pcs_pma_inst|altera_tse_mac_pcs_pma_ena:altera_tse_mac_pcs_pma_ena_inst|altera_tse_top_gen_host:top_gen_host_inst|altera_tse_top_w_fifo_10_100_1000:U_MAC_TOP|altera_tse_top_w_fifo:U_MAC|altera_tse_top_1geth:U_GETH|altera_tse_mac_tx:U_TX|gen_pause_muxc[0]}]
