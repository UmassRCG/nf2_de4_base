...
set PCS_REV_ADDRESS 				[expr {$MAC_1_BASE_ADDRESS + 0x244}];
set PCS_SCRATCH_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x240}];
set PCS_IF_MODE_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x250}];
set PCS_CONTROL_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x200}];
set PCS_STATUS_ADDRESS 				[expr {$MAC_1_BASE_ADDRESS + 0x204}];
set PCS_PARTNER_ABILITY_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x214}];
