...
set PHY_CONFIG_ADDRESS 					[expr {$MAC_0_BASE_ADDRESS + 0x40}];  
set PHY_CONTROL_ADDRESS 				[expr {$MAC_0_BASE_ADDRESS + 0x280}];
set PHY_ADVERTISEMENT_ADDRESS 			[expr {$MAC_0_BASE_ADDRESS + 0x290}];
set PHY_1000_BASE_T_ADDRESS 			[expr {$MAC_0_BASE_ADDRESS + 0x2A4}];
set PHY_SPECIFIC_CONTROL_ADDRESS 		[expr {$MAC_0_BASE_ADDRESS + 0x2C0}];
set PHY_EXD_SPECIFIC_STATUS_ADDRESS 	[expr {$MAC_0_BASE_ADDRESS + 0x2EC}];
set PHY_SPECIFIC_STATUS_ADDRESS 		[expr {$MAC_0_BASE_ADDRESS + 0x2C4}];
