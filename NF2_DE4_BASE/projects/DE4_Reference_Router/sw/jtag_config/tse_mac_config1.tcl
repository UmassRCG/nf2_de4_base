...
set REV_ADDRESS 				[expr {$MAC_1_BASE_ADDRESS + 0x0}];
set MAC_SCRATCH_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0x4}];
set COMMAND_CONFIG_ADDRESS		[expr {$MAC_1_BASE_ADDRESS + 0x8}];
set MAC_0_ADDRESS 				[expr {$MAC_1_BASE_ADDRESS + 0xC}];
set MAC_1_ADDRESS 				[expr {$MAC_1_BASE_ADDRESS + 0x10}];
set FRM_LENGTH_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x14}];
set PAUSE_QUANT_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0x18}];
set RX_SECTION_EMPTY_ADDRESS	[expr {$MAC_1_BASE_ADDRESS + 0x1C}];
set RX_SECTION_FULL_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x20}];
set TX_SECTION_EMPTY_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x24}];
set TX_SECTION_FULL_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x28}];
set RX_ALMOST_EMPTY_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x2C}];
set RX_ALMOST_FULL_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0x30}];
set TX_ALMOST_EMPTY_ADDRESS 	[expr {$MAC_1_BASE_ADDRESS + 0x34}];
set TX_ALMOST_FULL_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0x38}];
set MDIO_ADDR0_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x3C}];
set MDIO_ADDR1_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x40}];
set REG_STATUS_ADDRESS 			[expr {$MAC_1_BASE_ADDRESS + 0x58}];
set TX_IPG_LENGTH_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0x5C}];
set TX_CMD_STAT_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0xE8}];
set RX_CMD_STAT_ADDRESS 		[expr {$MAC_1_BASE_ADDRESS + 0xEC}];
set MAC_ADDRESS_NEXT 			[expr {$MAC_1_BASE_ADDRESS + 0x400}];
